...
export default function HeroContent({ dict }: HeroContentProps) {
  ...
  function smoothScrollToElement(target: HTMLElement, duration = 300) {
    ...
    const offset = window.innerHeight * 0.05 // 5% del viewport
