  ...
  return createPortal(
    isButtonVisible && !isFooterVisible && (
      <button
        ...
        className="fixed bottom-2 md:bottom-4 right-6 md:right-12 z-[99999] min-w-[44px] min-h-[44px] bg-white/10 backdrop-blur-sm flex items-center justify-center rounded-full hover:bg-white/20 transition-all duration-200 hover:scale-105"
