...
export const metadata = {
  ...
  alternates: {
    canonical: '/playground/rectofinal',
  },
  openGraph: {
    title: "Recto Final | Videojuego físico-digital | Lautaro R. Temperini",
    description:
    ...
    url: "https://temperini.vercel.app/playground/rectofinal",
        ...
        <CaseStudyLayout>
          ...
          <ProseSection className="mb-16">
            ...
            <div className="prose prose-invert max-w-none text-[#F1F1F1] leading-relaxed">
              ...
              <p className="text-light font-semibold">La mejor tecnología es la que se hace invisible cuando el usuario está completamente inmerso en golpear calaveras dentro del estómago de un dinosaurio.</p>
            </div>
          </ProseSection>
